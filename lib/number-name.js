...
(function ()
{
    ...
    function setUp(self)
    {
        if (self != null)
        {
            ...
            (self, 'numberName', { configurable: true, value: numberName, writable: true });
        }
    }
    ...
    [-321, -319, -318, -315, -313, -311, -309, -307, -306, -303, -301, -299, -298, -295, Infinity];
    ...
    {
        Object.defineProperty
        (numberName, 'toString', { configurable: true, value: toString, writable: true });
        ...
        if (typeof DEBUG === 'undefined' || /* c8 ignore next */ DEBUG)
        {
            ...
            (
                ...
                {
                    PRECISION_LIMITS:
                    { configurable: true, value: PRECISION_LIMITS, writable: true },
                    setUp: { configurable: true, value: setUp, writable: true },
                }
            );

            Object.defineProperty
            (numberName, 'debug', { configurable: true, value: debug, writable: true });
        }

        setUp(typeof self === 'undefined' ? null : /* c8 ignore next */ self);
